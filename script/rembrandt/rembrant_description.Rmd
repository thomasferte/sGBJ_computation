...
df_rembrandt = readRDS(here::here("data/rembrandt/dfGenesAndClinical.rds"))
...
pca_coord <- pca_model$ind$coord |> 
  as.data.frame() |> 
  mutate(BIOSPECIMEN_ID = df_rembrandt_clean$BIOSPECIMEN_ID,
         DISEASE_TYPE = df_rembrandt_clean$DISEASE_TYPE,
         .before = 1)
