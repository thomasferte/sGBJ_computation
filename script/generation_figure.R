### import data
results=read.table("results/comparaison_survival_sets_bis_corr_beta6_bis_2000.txt",
                   col.names = c("ite","beta","corr","cens","prop","size","gt","wt","bst","gbj"))
combinaisons=read.table("data/simulations_table.txt",header=TRUE)

# Je comprends rien à cette section
###
